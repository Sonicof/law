...
class LawyerWidget extends StatefulWidget {
  ...
  static String routeName = 'Lawyer';
  static String routePath = '/lawyer';
...
class _LawyerWidgetState extends State<LawyerWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LawyerModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.lawyerRead =
          await LawyerRecord.getDocumentOnce(widget.lawyerRef!);
    });
                            ...
                            child: ExpandablePanel(
                              ...
                              collapsed: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      _model.lawyerRead?.practiceareas,
                                      'Anticipatory Bail, Cheque Bounce, Child Custody, Court Marriage, Divorce, Domestic Violence, Dowry Case, Family, Fraud Case, High Court, NRI, Recovery, Succession Certificate, Wills / Trusts, Women',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
