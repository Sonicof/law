...
class _Auth2CreateWidgetState extends State<Auth2CreateWidget>
  ...
  void initState() {
    ...
    _model.cnfpasswordTextController ??= TextEditingController();
    _model.cnfpasswordFocusNode ??= FocusNode();
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                width: double.infinity,
                                child: TextFormField(
                                  controller: _model.cnfpasswordTextController,
                                  focusNode: _model.cnfpasswordFocusNode,
                                  autofocus: true,
                                  autofillHints: [AutofillHints.password],
                                  obscureText: !_model.cnfpasswordVisibility,
                                  decoration: InputDecoration(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primary,
                                  validator: _model
                                      .cnfpasswordTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.passwordTextController.text !=
                                      _model.cnfpasswordTextController.text) {
