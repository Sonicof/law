...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => GeminiChatPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: LawyerWidget.routeName,
          path: LawyerWidget.routePath,
          builder: (context, params) => LawyerWidget(
            lawyerRef: params.getParam(
              'lawyerRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['lawyer'],
            ),
          ),
        ),
        FFRoute(
